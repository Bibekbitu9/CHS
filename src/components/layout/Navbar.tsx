      ...
      <div className={`container ${styles.navContainer}`}>
        ...
        >
          ...
          <motion.div variants={{ hidden: { opacity: 0, scale: 0.8 }, visible: { opacity: 1, scale: 1 } }}>
            <Link to="/about" className="btn-primary" style={{ padding: '10px 24px', fontSize: '0.9rem', boxShadow: '0 4px 14px rgba(205, 127, 50, 0.3)' }}>
              Join CHS
            </Link>
          </motion.div>
        </motion.nav>
      ...
      <AnimatePresence>
        {isMobileMenuOpen && (
          ...
          >
            ...
            <Link to="/about" className="btn-primary" style={{ textAlign: 'center', margin: '16px' }} onClick={() => setIsMobileMenuOpen(false)}>
              Join CHS
            </Link>
          </motion.nav>
        )}
