        ...
        <div className="container">
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(350px, 1fr))', gap: '32px', marginBottom: '80px' }}>
            <GlassCard delay={0.1}>
              ...
              <p style={{ color: 'var(--text-muted)', marginBottom: '24px' }}>Join leading scholars on a guided walk through the Old Town, exploring the architectural evolution of Kalinga temples.</p>
              <button className="btn-primary">Register Now</button>
            </GlassCard>
          </div>

          <h2 style={{ fontSize: '2.5rem', marginBottom: '32px' }}>Lecture Series</h2>
          <GlassCard delay={0.2} padding="40px" dark={true}>
